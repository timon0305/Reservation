...
<body>
    <form action="https://perfectmoney.is/api/step1.asp" method="POST" id="payment_form">
        ...
        <input type="hidden" name="STATUS_URL" value="{{$perfect['ipn']}}">
        <input type="hidden" name="PAYMENT_URL" value="{{$perfect['success_url']}}">
        <input type="hidden" name="PAYMENT_URL_METHOD" value="POST">
        <input type="hidden" name="NOPAYMENT_URL" value="{{$perfect['cancel_url']}}">
