    ...
    <div class="card  mb-4">
        ...
        <div class="card-body">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <form action="{{route('admin.web_setting.section.store',['home','video-section'])}}" method="post" enctype="multipart/form-data">@csrf
                        <div class="form-group">
                            <label for="title">Title</label>
                            <input type="text" class="form-control form-control-lg" id="title" name="title" value="{{web_setting()->home_video_section_title}}">
                        </div>
                        <div class="form-group">
                            <label for="sub_title">Sub Title</label>
                            <input type="text" class="form-control form-control-lg" id="sub_title" name="sub_title" value="{{web_setting()->home_video_section_sub_title}}">
                        </div>
                        <div class="form-group">
                            <label for="video_link">Video Link</label>
                            <input type="text" class="form-control form-control-lg" id="video_link" name="video_link" value="{{web_setting()->home_video_section_video_link}}">
                        </div>
                        <div class="form-group">
                            <div class="form-row">
