    ...
    <div class="card  mb-4">
        ...
        <div class="card-body">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <form action="{{route('admin.web_setting.section.store',['home','facility_section'])}}" method="post" enctype="multipart/form-data">@csrf
                        <div class="form-group">
                            <label for="title_1">Title 1</label>
                            <input type="text" class="form-control form-control-lg" id="title_1" name="title_1" value="{{web_setting()->home_facility_section_title_1}}">
                        </div>
                        <div class="form-group">
                            <label for="title_2">Sub Title</label>
                            <input type="text" class="form-control form-control-lg" id="title_2" name="title_2" value="{{web_setting()->home_facility_section_title_2}}">
                        </div>
                        <div class="form-group">
                            <hr/>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <table class="table table-sm table-striped mb-0">
                        ...
                        <tbody>
                        @forelse(\App\Model\WebSetting\WebFacility::all() as $key=>$value)
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row justify-content-center">
                                                <div class="col-md-12">
                                                    <form action="{{route('admin.web_setting.facility.update',$value->id)}}" method="post" enctype="multipart/form-data">@csrf
                                                        <div class="form-group">
                        ...
                        <tr>
                            <td >{{$key+1}}</td>
                            <td ><img src="{{asset('assets/frontend/img/home/facility_section/'.$value->image)}}" style="width: 100px;max-height: 200px"></td>
                            <td >{{$value->name}}</td>
                            <td class="text-right">
                                <div class="btn-group">
                                ...
                                <form action="{{route('admin.web_setting.facility.delete',$value->id)}}" id="delete_form_{{$value->id}}" method="post">@csrf</form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <form action="{{route('admin.web_setting.facility.store')}}" method="post" enctype="multipart/form-data">@csrf
