            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <table class="table table-sm table-striped mb-0">
                        ...
                        <tbody>
                        @forelse(\App\Model\WebSetting\WebCounterSection::all() as $key=>$value)
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row justify-content-center">
                                                <div class="col-md-12">
                                                    <form action="{{route('admin.web_setting.home.counter-section.update',$value->id)}}" method="post" enctype="multipart/form-data">@csrf
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="number" name="number" value="{{$value->number}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <hr/>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <form action="{{route('admin.web_setting.home.counter-section.delete',$value->id)}}" id="delete_form_{{$value->id}}" method="post">@csrf</form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <form action="{{route('admin.web_setting.home.counter-section.store')}}" method="post" enctype="multipart/form-data">@csrf
